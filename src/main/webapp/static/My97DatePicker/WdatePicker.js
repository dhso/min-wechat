...
(function () {
    ...
    function U(K, C) {
        ...
        if (C) {
            ...
            if (!L.el || L.el["My97Mark"] === true || L.el.disabled || ($dp.dd && P($dp.dd) != "none" && $dp.dd.style.left !=
                "-970px")) {
                try {
    ...
    function I(G, _) {
        ...
        if (_ || G.eCont || new RegExp(/input|textarea|div|span|p|a/ig).test(D)) G.elProp = D == "INPUT" ? "value" :
                "innerHTML";
        ...
        function E(K, J) {
            ...
            function C() {
                ...
                for (var C = 0; C < D.length; C++) if (D[C].name == J.skin) $.push(
                            "<link rel=\"stylesheet\" type=\"text/css\" href=\"" + A + "skin/" + D[C].name +
